...
// vector2D.h previously included here for the now-removed vector helpers
// (see comment near vGetLengthOfNormal below). Definitions moved to
// libs/geoprim/src/vector2D.cpp; nothing else in this file references
// the type.
...
// vGetLengthOfNormal / vDotProduct / vAddVectors / vSubtractVectors /
// vVectorSquared / vVectorMagnitude used to live here. They are vector
// primitives that libs/geoprim called via LOD_reduce, which created a
// circular layering (model depends on geoprim, but geoprim called into
// model). They now live in libs/geoprim/src/vector2D.cpp where they
// belong.
