...
const QColor GpxxColors[] = {
    QColor(0x00, 0x00, 0x00), QColor(0x60, 0x00, 0x00),
    QColor(0x00, 0x60, 0x00), QColor(0x80, 0x80, 0x00),
    QColor(0x00, 0x00, 0x60), QColor(0x60, 0x00, 0x60),
    QColor(0x00, 0x80, 0x80), QColor(0xC0, 0xC0, 0xC0),
    QColor(0x60, 0x60, 0x60), QColor(0xFF, 0x00, 0x00),
    QColor(0x00, 0xFF, 0x00), QColor(0xF0, 0xF0, 0x00),
    QColor(0x00, 0x00, 0xFF), QColor(0xFE, 0x00, 0xFE),
