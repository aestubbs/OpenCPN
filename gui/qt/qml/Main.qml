...
ApplicationWindow {
    ...
    ChartCanvas {
        ...
        // --- Vessel data HUD: expandable right-edge panel, gauges stacked
        //     vertically. Fixed yacht layout for now; the gauge stack is
        //     wrapped so future "pages" can swap layouts (engine, etc.).
        Item {
            id: hudPanel
            anchors.right: parent.right
            anchors.top: parent.top
            anchors.bottom: parent.bottom
            width: root.hudExpanded ? 300 : 26
            ...
            // Left-edge toggle tab (always visible).
            Rectangle {
                id: hudTab
                width: 26; height: 70; radius: 6
                anchors.left: parent.left
                anchors.verticalCenter: parent.verticalCenter
                color: "#cc101418"; border.color: "#3affffff"
                Text {
                    anchors.centerIn: parent
                    text: root.hudExpanded ? "›" : "‹"
                    color: "#e0e0e0"; font.pointSize: 16
                }
                MouseArea {
                    anchors.fill: parent
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            Layout.fillWidth: true
                            Label { text: "--"; color:"#e8e8e8"; font.pointSize: 22; Layout.alignment: Qt.AlignHCenter }
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            ctx.stroke()
                            // AWA needle (green) when data present.
                            if (windGauge.awa >= 0) {
